    ...
    <div className={styles.container}>
      ...
      {instructor &&
          instructor.course.map((element) => {
            ...
            {/* <Link to={`/course/id`} className={styles.itemCourse}>
                <img alt="course item" src="https://miro.medium.com/max/720/1*aBQrwweY6-qFVWeizUrTnQ.png" className={styles.imgCourse}></img>
                <div className={styles.courseInfo}>
                    <div className={styles.courseName}>Khóa học Reactjs 2022</div>
                    <div className={styles.infoInstructor}>
                        <img className={styles.imgUser} alt="img_user" src="https://www.kindpng.com/picc/m/24-248442_female-user-avatar-woman-profile-member-user-profile.png"></img>
                        <div className={styles.userName}>Huu Tin</div>
                        <div className={styles.checkIcon}><i className="fa-solid fa-circle-check"></i></div>
                    </div>
                    <div className={styles.coursePrice}>12$</div>
                </div>
            </Link>
            ...
            <Link to={"."} className={styles.itemCourse}>
                <img alt="course item" src="https://miro.medium.com/max/720/1*aBQrwweY6-qFVWeizUrTnQ.png" className={styles.imgCourse}></img>
                <div className={styles.courseInfo}>
                    <div className={styles.courseName}>Khóa học Reactjs Angularjs Vuejs 2022</div>
                    <div className={styles.infoInstructor}>
                        <img className={styles.imgUser} alt="img_user" src="https://www.kindpng.com/picc/m/24-248442_female-user-avatar-woman-profile-member-user-profile.png"></img>
                        <div className={styles.userName}>Huu Tin</div>
                        <div className={styles.checkIcon}><i className="fa-solid fa-circle-check"></i></div>
