...
namespace WebAPI.Endpoints.VNPay
{
    public class Payment : BaseAsyncEndpoint
    {
        ...
        public async Task<ActionResult<string>> PaymentAsync ([FromForm]PaymentResponse data, CancellationToken cancellationToken = default)
        {
            ...
            pay.AddRequestData("vnp_IpAddr", data.ip); //Địa chỉ IP của khách hàng thực hiện giao dịch
