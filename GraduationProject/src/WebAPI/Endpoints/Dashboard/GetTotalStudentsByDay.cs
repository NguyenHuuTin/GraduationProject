...
{  
    public class GetTotalStudentsByDay : BaseAsyncEndpoint<object>
    {
        private readonly IDashboardService _dashboardService;

        public GetTotalStudentsByDay(IDashboardService dashboardService)
        {
            _dashboardService = dashboardService;
        }


        [HttpGet("/dashboard/get-total-student-by-day")]
        [SwaggerOperation(
